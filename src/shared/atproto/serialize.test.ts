...
import { blocknoteToLexicon, lexiconToBlocknote, createLexiconContent } from "./serialize";
        ...
        content: [
          {
            ...
            content: [{ type: "text", text: "click me", styles: { bold: true } }],
          },
        ],
        children: [],
      },
            ...
            children: [
              {
                id: "rt3b",
                type: "bulletListItem",
                content: [{ type: "text", text: "deep nested", styles: {} }],
              },
            ],
          },
        ],
        ...
        children: [
          {
            id: "mc1a",
            type: "paragraph",
            content: [{ type: "text", text: "Nested Paragraph 1", styles: {} }],
          },
          {
            id: "mc1b",
            type: "paragraph",
            content: [{ type: "text", text: "Nested Paragraph 2", styles: {} }],
          },
          {
            id: "mc1c",
            type: "paragraph",
            content: [{ type: "text", text: "Nested Paragraph 3", styles: {} }],
          },
        ],
      },
    ];
        ...
        children: [
          {
            id: "cs2a",
            type: "paragraph",
            content: [{ type: "text", text: "Nested Paragraph 4", styles: {} }],
          },
          {
            id: "cs2b",
            type: "paragraph",
            content: [{ type: "text", text: "Nested Paragraph 5", styles: {} }],
          },
          {
            id: "cs2c",
            type: "paragraph",
            content: [{ type: "text", text: "Nested Paragraph 6", styles: {} }],
          },
        ],
      },
    ];
  ...
  test("all basic block types (paragraph, heading, lists, code, table, image, divider)", () => {
    const original = [
      ...
      },
      {
        id: "bb3",
        type: "numberedListItem",
        content: [{ type: "text", text: "Numbered List Item 1", styles: {} }],
      },
      {
        id: "bb4",
        type: "bulletListItem",
        content: [{ type: "text", text: "Bullet List Item 1", styles: {} }],
      },
      {
        id: "bb5",
        type: "checkListItem",
        content: [{ type: "text", text: "Check List Item 1", styles: {} }],
      },
      {
        id: "bb6",
        type: "toggleListItem",
        content: [{ type: "text", text: "Toggle List Item 1", styles: {} }],
      },
      {
        id: "bb7",
        type: "codeBlock",
          ...
          rows: [
            {
              cells: [
                {
                  content: [{ type: "text", text: "Table Cell 1", styles: {} }],
                },
                {
                  content: [{ type: "text", text: "Table Cell 2", styles: {} }],
                },
              ],
            },
            {
              cells: [
                {
                  content: [{ type: "text", text: "Table Cell 3", styles: {} }],
                },
                {
                  content: [{ type: "text", text: "Table Cell 4", styles: {} }],
                },
              ],
            },
          ],
              ...
              cells: [
                {
                  ...
                  content: [{ type: "text", text: "Row Cell", styles: {} }],
                },
                {
